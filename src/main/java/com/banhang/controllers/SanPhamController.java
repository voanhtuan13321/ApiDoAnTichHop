...
public class SanPhamController {
	...
	@GetMapping(path = "/timkiem")
	public ResponseEntity<ResponObject> getSanPhamBySearch(@RequestBody String searchStr) {
		return sanPhamService.searchSanPham(searchStr);
	}
